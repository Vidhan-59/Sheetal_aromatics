        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl font-bold font-serif">Essential Oils</h1>
                <p className="text-xl text-green-100">Pure & Natural</p>
              </div>
            </div>
            <p className="text-lg text-green-100 max-w-2xl">
              Premium quality essential oils extracted from the finest natural sources. Perfect for aromatherapy,
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2 mb-4 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-accent font-medium">99%+ Pure</span>
                    </div>
                  </div>
                  ...
                  {product.applications && product.applications.length > 0 && (
                    <div className="mb-4">
                      ...
                      <p className="text-xs">{product.applications.slice(0, 2).join(", ")}</p>
                    </div>
                  )}
