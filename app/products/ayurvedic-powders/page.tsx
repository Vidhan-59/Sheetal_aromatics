        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl font-bold font-serif">Ayurvedic Powders</h1>
                <p className="text-xl text-green-100">Finely Processed</p>
              </div>
            </div>
            <p className="text-lg text-green-100 max-w-2xl">
              Premium quality herbal powders processed with advanced techniques. Ideal for supplement manufacturing and
              wellness products.
            </p>
          </div>
        </div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2 mb-4 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-accent font-medium">{product.purity || "Natural Grade"}</span>
                    </div>

                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Form:</span>
                      <span className="capitalize">Fine Powder</span>
                    </div>
                  </div>
