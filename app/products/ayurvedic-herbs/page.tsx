        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl font-bold font-serif">Ayurvedic Herbs</h1>
                <p className="text-xl text-green-100">Traditional Wellness</p>
              </div>
            </div>
            <p className="text-lg text-green-100 max-w-2xl">
              Authentic ayurvedic herbs sourced from trusted suppliers. Perfect for pharmaceutical, nutraceutical, and
